...
import {Bell, CreditCard, Package, Plus, ShoppingCart} from "lucide-react";
import {ordersOverview, statsData} from "@/shared/lib/data.ts";
import {Card, CardContent} from "@/shared/components/card.tsx";
...
export function StatsGrid() {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <span
                className="text-xs text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/20 px-2 py-1 rounded-full font-normal">
              +24% this month
            </span>
                    </div>
                </CardContent>
