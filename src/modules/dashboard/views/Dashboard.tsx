...
import {StatsGrid} from "@/modules/dashboard/components/stats-grid.tsx";
import {ProjectsTable} from "@/modules/dashboard/components/projects-table.tsx";
import {ChartsShowcase} from "@/modules/dashboard/components/charts-showcase.tsx";

export const Dashboard = () => {
    return (<div className="h-full overflow-y-auto p-6 custom-scrollbar">
